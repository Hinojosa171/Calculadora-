def resta(a, b):
    ...
    # Procesamos el segundo número (invertido para resta)
    if b >= 0:
        for _ in range(b):
            c.append(-1)  # Agregamos 'b' elementos negativos para restar
    else:
        #Calculamos valor absoluto manualmente sin usar abs
        b_abs = -b
        for _ in range(b_abs):
            c.append(1)  # Agregamos 'b' elementos positivos si b es negativo
